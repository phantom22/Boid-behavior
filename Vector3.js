...
Vector3.prototype = { 
	...
	get normalize() { const magnitude = this.magnitude; let normalized; if (magnitude != 0) { normalized = Vector3.divide(this, Vector3.from_number(magnitude)) } else { normalized = Vector3.from_number(0) } return normalized },
